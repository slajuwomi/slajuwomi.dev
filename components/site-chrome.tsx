  ...
  return (
    <>
      <header className="flex flex-wrap items-center gap-3 text-sm sm:flex-nowrap">
        <Link
          href="/"
          className="mr-auto whitespace-nowrap font-semibold text-neutral-700 dark:text-neutral-300"
        >
          stephen lajuwomi
        </Link>
        ...
        <button
          ...
          className="hidden items-center gap-1.5 rounded-[9px] border border-stone-300 bg-stone-100 px-1.5 py-1 text-stone-600 shadow-sm md:flex dark:border-stone-700 dark:bg-[#292727] dark:text-stone-200 dark:shadow-black/20"
